...
import { ArrowRight, Brain, TrendingUp, Users, Sparkles } from "lucide-react";
...
export function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden" data-testid="hero-section">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1759884247199-eceeff174430?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjB3b3Jrc3BhY2UlMjBjb2RpbmclMjBsYXB0b3B8ZW58MXx8fHwxNzcxODU3MjExfDA&ixlib=rb-4.1.0&q=80&w=1080"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-3xl p-12 text-white">
            ...
            <Link to="/consultation">
              <Button size="lg" variant="secondary" className="gap-2" data-testid="cta-book-btn">
                {t("home.ctaButton")}
                <ArrowRight className="w-4 h-4" />
              </Button>
            </Link>
